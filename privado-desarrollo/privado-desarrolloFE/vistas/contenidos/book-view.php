...
<div class="container-fluid">
	<div class="page-header">
	  <h1 class="text-titles"><i class="zmdi zmdi-account-add zmdi-hc-fw"></i> Administración <small>INVENTARIO DE EQUIPOS VARIOS</small></h1>
	</div>
</div>
...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
	  	...
	  	<li>
	  		<a style="border: 1px solid #5bc0de" href="<?php echo SERVERURL; ?>bookarma/" class="btn btn-info">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form autocomplete="off" class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/AdministradorAjax.php" enctype="multipart/form-data" method="POST" data-form="save">
				<input type="hidden" name="tipoFormulario" value="newEquipo">
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	<label class="control-label">Numero Inventario o registro *</label>
		    				...
		    				<div class="col-xs-12 col-sm-6">
						    	<div class="form-group label-floating">
								  	...
								  	<select id="tipoEvento-reg" class="form-control" name="sede-reg" >
		...
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-striped table-bordered display" id="table_id">
					<?php echo $dato = $datos->seleccinarEquiposControlador();?>
				</table>
			</div>
		</div>
	</div>

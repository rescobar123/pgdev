...
<?php require_once "./controladores/AgenteControlador.php"; 
	$insAdmin = new AgenteControlador();
...
<div class="container-fluid">
	<div class="panel panel-primary">
		...
		<?php 
				...
				echo $insAdmin->paginadorAdministradorControlador($pagina['1'],1,$_SESSION['privilegio_sbp'], $_SESSION['codigo_cuenta_sbp'], $_SESSION['busqueda_admin']);
		?>
		</div>
	</div>
</div>

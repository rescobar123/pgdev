      ...
      <div class="col-sm-12 col-md-12">
        <div class="product-table">
          <table class="table">
            ...
            <tbody>
              <tr>
                <td class="col-sm-8 col-md-6"><div class="media"> <a class="thumbnail pull-left" href="#"> <img class="media-object" src="https://withtechnologyonline.com/wp-content/uploads/2020/04/Descargar-Norton-Antivirus-GRATIS-1-1.png" alt="#"></a>
              ...
              <tr>
                <td class="col-md-6"><div class="media"> <a class="thumbnail pull-left" href="#"> <img class="media-object" src="https://withtechnologyonline.com/wp-content/uploads/2020/04/Descargar-Norton-Antivirus-GRATIS-1-1.png" alt="#"></a>
                    <div class="media-body">
